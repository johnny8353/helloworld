 ...
 * 文件编号：BL_PU2010101_FrameMcrmException 
 * 文件名称：FrameMcrmException.java
 * 系统编号：100000201191
 * 系统名称：移动CRM
 * 组件编号：MCRM_CJ001
 ...
 * 完成日期：2014-10-15
 * 设计文档：XXX
 * 内容摘要：基础框架组件的异常处理类，负责统一处理基础框架组件产生的异常 。 
 *
 * 修改记录：01
...
/**
 * 类 编 号：BL_PU2010101_FrameMcrmException
 * 类 名 称：FrameMcrmException
 * 内容摘要：基础框架组件的异常处理类，负责统一处理基础框架组件产生的异常 
 * 完成日期：2014-10-15
 * 编码作者：JohnnyHuang 黄福强
 */
public class FrameMcrmException extends McrmException
{
	...
	//模块组件名称
		private final static String CJ001_NAME="基础框架";
		//模块组件编号
		private final static String CJ001_CODE="CJ001";
		
	    public FrameMcrmException()
	    {
	    	getMcrmExceptionBO().getMcrmExceptionVO().setModuleName(CJ001_NAME);
	    }
	    ...
	    {
	    	McrmExceptionComm.throwMcrmException(errorLayer,CJ001_NAME,CJ001_CODE,className,exception);
	    }
	    /**
	    ...
	    {
	    	return McrmExceptionComm.generateMcrmException(errorLayer, CJ001_NAME,CJ001_CODE, className, exception);
	    }
}
